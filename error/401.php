<?php
/*
PROGRAM NAME: 401 Unauthorized Error Page (401.php)

PROGRAMMER: Backend Team

SYSTEM CONTEXT:
This page is part of the BuzzarFeed platform and serves as the custom error page for HTTP 401 (Unauthorized) responses.
It is displayed to users when they attempt to access a page that requires authentication.
...
PURPOSE:
To inform users that authentication is required to access the requested resource and provide alternative navigation options.
Key features include:
- Display of 401 error code and descriptive message
- Explanation of why authentication is needed
- Action buttons to log in, sign up, or go to homepage
...
7. Render HTML structure:
   ...
   d. Display 401 error code, icon, descriptive message, and explanation of authentication requirement.
   e. Provide action buttons to log in, sign up, or return to homepage.
8. Include main JavaScript module for interactive behaviors.

NOTES:
- This error page is fully responsive and accessible.
- Future enhancements may include redirecting users to the login page automatically or remembering the requested page post-login.
- Logging ensures developers can track unauthorized access attempts and improve platform security.
*/
...
// Now set 401 header after session is started
...
// Log to error log
error_log("=== 401 UNAUTHORIZED ERROR ===");
...
$pageTitle = "401 - Unauthorized | BuzzarFeed";
$pageDescription = "Authentication required to access this page";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <main>
        <div class="error-container">
            ...
            <p class="error-description">
                ...
                Think of it as needing a ticket to enter the night market!
            </p>
            ...
            <div class="error-actions">
                ...
                <a href="<?= BASE_URL ?>signup.php" class="btn btn-secondary btn-large">
                    <i class="fas fa-user-plus"></i> Sign Up
                </a>
                <a href="<?= BASE_URL ?>" class="btn btn-outline btn-large">
            ...
            <div class="error-info-box">
                ...
                <p>
                    <strong>Protected content</strong> - This page contains features that require you to be logged in.<br><br>
                    <strong>Personalized experience</strong> - By logging in, you can access your account, reviews, and preferences.<br><br>
                    <strong>Don't have an account?</strong> - It's quick and easy to sign up! Join our community today.
                </p>
            </div>
        </div>
    </main>
