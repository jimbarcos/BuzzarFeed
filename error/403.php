<?php
/*
PROGRAM NAME: 403 Forbidden Error Page (403.php)

PROGRAMMER: Backend Team

SYSTEM CONTEXT:
This page is part of the BuzzarFeed platform and serves as the custom error page for HTTP 403 (Forbidden) responses.
It is displayed to users when they attempt to access a page or resource for which they do not have permission.
...
PURPOSE:
To inform users that they do not have permission to access the requested resource and provide alternative navigation options.
Key features include:
- Display of 403 error code and descriptive message
- Explanation of potential causes (insufficient permissions, restricted content)
- Action buttons to homepage or go back
...
7. Render HTML structure:
   ...
   d. Display 403 error code, icon, descriptive message, and explanation of why access is forbidden.
   e. Provide action buttons to homepage or go back.
8. Include main JavaScript module for interactive behaviors.

NOTES:
- This error page is fully responsive and accessible.
- Future enhancements may include role-specific messages or redirect suggestions based on user type.
